...
import { ProductBrand, ProductStatus } from '../../../libs/enums/product.enum';
			...
			if (newValue !== 'ALL') {
				setProductsInquiry({
					...
					search: {
						...
						productBrandList: [newValue as ProductBrand],
					},
				});
			} else {
				delete productsInquiry?.search?.productBrandList;
				setProductsInquiry({ ...productsInquiry });
			}
		} catch (err: any) {
						...
						<Box component={'div'}>
							...
							<Stack className={'search-area'} sx={{ m: '24px' }}>
								<Select sx={{ width: '160px', mr: '20px' }} value={searchType}>
									...
									{Object.values(ProductBrand).map((brand: string) => (
