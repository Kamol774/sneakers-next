...
const ProductDetail: NextPage = ({ initialComment, ...props }: any) => {
	...
	const {
		...
		skip: !productId, // productId mavjud bolmasa mantiq amalga oshmasin
	...
	const {
		...
		variables: {
			input: {
				...
				search: {
					brandList: product?.productBrand ? [product?.productBrand] : [],
				},
			},
		},
		...
		try {
			...
			await getProductsRefetch({
				input: {
					...
					direction: Direction.DESC,
					search: {
						brandList: [product?.productBrand],
					},
				},
			});
						...
						<Stack className={'product-info-config'}>
							<Stack className={'info'}>
								<Stack className={'left-box'}>
									...
									<Stack className={'top-box'}>
										<Typography className={'city'}>{product?.productBrand}</Typography>
									...
									<Stack className={'bottom-box'}>
										<Stack className="option">
											...
											<Typography>{product?.productSeason} season</Typography>
										</Stack>
										<Stack className="option">
											<img src="/img/icons/color.svg" alt="" /> <Typography>{product?.productColor} color</Typography>
										</Stack>
										<Stack className="option">
											<img src="/img/icons/size.webp" alt="" /> <Typography>{product?.productSize} size</Typography>
										</Stack>
									</Stack>
								</Stack>
							...
							<Stack className={'images'}>
								<Stack className={'main-image'}>
									<img
										src={slideImage ? `${REACT_APP_API_URL}/${slideImage}` : '/img/product/sneaker.svg'}
										alt={'main-image'}
									/>
								</Stack>
						...
						<Stack className={'product-desc-config'}>
								...
								<Stack className={'options-config'}>
									...
									<Stack className={'option'}>
										...
										<Stack className={'option-includes'}>
											...
											<Typography className={'option-data'}>{product?.productColor}</Typography>
										</Stack>
									</Stack>
									<Stack className={'option'}>
										<Stack className={'svg-box'}>
										...
										<Stack className={'option-includes'}>
											...
											<Typography className={'option-data'}>{product?.productSize} </Typography>
										</Stack>
									</Stack>
									<Stack className={'option'}>
										<Stack className={'svg-box'}>
											<img src="/img/icons/gender.webp" alt="" />
										</Stack>
										<Stack className={'option-includes'}>
										...
										<Stack className={'info-box'}>
											<Stack className={'left'}>
												...
												<Box component={'div'} className={'info'}>
													...
													<Typography className={'data'}>{product?.productSeason}</Typography>
												</Box>
											</Stack>
							...
							<Stack className={'right-config'}>
								...
								<Stack className={'info-box'}>
									...
									<input type={'text'} placeholder={'x.k.1993@mail.ru'} />
								</Stack>
								<Stack className={'info-box'}>
							...
							<Stack className={'similar-products-config'}>
								<Stack className={'title-pagination-box'}>
									<Stack className={'title-box'}>
										<Typography className={'main-title'}>Same Products</Typography>
										<Typography className={'sub-title'}>They looks like same products</Typography>
									</Stack>
